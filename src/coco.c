...
void run_coco(int argc, char **argv)
{
    ...
    int cam_index1 = find_int_arg(argc, argv, "-c1", 1);
    ...
    else if(0==strcmp(argv[2], "demo")) demo(cfg, weights, thresh, hier_thresh, cam_index, cam_index1, filename, coco_classes, 80, 1, frame_skip,
